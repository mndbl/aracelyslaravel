...
<img class="float-right pl-4" src="https://images.unsplash.com/photo-1600880292089-90a7e086ee0c?ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8bWFuYWdlbWVudHxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" alt="">
<p class="text-justify text-sm px-4 mr-4">
...
become volunteers without any additional cost.</p><p class="text-justify text-sm px-4 ">
...
also installed electricity generators in each of our subsidiaries in case power goes out. </p>
<p class="text-justify text-sm px-4 font-bold mt-2">DISCIPLINE PLAN</p>
<p class="text-justify text-sm px-4 ">The 305 Total Experience has a strict discipline policy, our discipline actions are braked
as following:</p>
<ul class="text-justify text-sm px-4 ml-4 my-2">
    <li>
